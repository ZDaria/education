...
from prog_python.art_of_software_testing.test_values import valid_employee_tab, \
    ...
    empty_leading_employee_tab, one_record_employee_tab, one_record_department_tab, \
    same_sales_department_tab, same_sales_employee_tab, leader_first_record_department_tab,\
    leader_employee_tab
...
@pytest.mark.parametrize('employee_tab, department_tab', [(one_record_employee_tab,
...
@pytest.mark.parametrize('employee_tab, department_tab', [(same_sales_employee_tab,
...
@pytest.mark.parametrize('employee_tab, department_tab', [(leader_employee_tab,
